  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-secondary/10">
        ...
        <div
          className="absolute bottom-32 right-16 w-3 h-3 bg-accent/20 rounded-full animate-ping"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/3 w-1 h-1 bg-success/30 rounded-full animate-ping"
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="text-center mb-16 download-header">
          ...
          <p className="text-lg md:text-xl text-base-content/70 max-w-3xl mx-auto leading-relaxed">
            Experience the future of transportation in Cagayan Valley. Download
            now and start your hassle-free travel journey today.
          </p>
        </div>
          ...
          <div className="download-card card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 group border-2 border-success/30">
            <div className="card-body p-8 text-center">
              ...
              <p className="text-base-content/70 mb-6">
                Perfect for passengers, the application enables users to track
                vans and buses in real-time and utilize the ping feature to
                signal drivers for a pickup within the service area.
              </p>
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2 w-full">
                  ...
                  >
                    <i
                      className={`fas fa-cloud mr-2 ${
                        commuterSource === "vercel" ? "text-white" : ""
                      }`}
                    ></i>
                    CDN
                  </button>
                  <button
                    className={`btn flex-1 ${
                      commuterSource === "mega"
                        ? "bg-error/20 text-error border-error/40 hover:bg-error/30"
                        : "btn-outline"
                    }`}
              ...
              <div className="space-y-3">
                <button
                  ...
                  disabled={
                    disabled.commuter[commuterSource] ||
          ...
          <div className="download-card card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 group border-2 border-primary/30">
            <div className="card-body p-8 text-center">
              <div className="w-20 h-20 border-2 border-primary/30 rounded-2xl flex items-center justify-center mx-auto mb-6 download-icon group-hover:scale-110 transition-transform">
                <i
                  className="fa-brands fa-android"
                  style={{ color: "#3B82F6", fontSize: "3rem" }}
                ></i>
              </div>
              <h3 className="text-2xl font-bold text-base-content mb-4">
                Android - Driver
              ...
              <p className="text-base-content/70 mb-6">
                Built for drivers and operators, the system facilitates trip
                optimization by displaying current vehicle passenger counts and
                pinpointing the location of commuters actively waiting on the
                map.
              </p>
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2 w-full">
                  ...
                  >
                    <i
                      className={`fas fa-cloud mr-2 ${
                        driverSource === "vercel" ? "text-white" : ""
                      }`}
                    ></i>
                    CND
                  </button>
