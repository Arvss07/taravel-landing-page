...
export default function HeroSection() {
  ...
  const getPhoneDimensions = () => {
    ...
    // Mobile adjustments
    if (screenSize.width < 640) { // sm breakpoint
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 800" fill="none">
          ...
          <defs>
            <radialGradient id="gradient1" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="oklch(48% 0.243 264.376)" stopOpacity="0.8"/>
              <stop offset="100%" stopColor="oklch(48% 0.243 264.376)" stopOpacity="0.2"/>
            </radialGradient>
            <radialGradient id="gradient2" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="oklch(37% 0.146 265.522)" stopOpacity="0.7"/>
              <stop offset="100%" stopColor="oklch(37% 0.146 265.522)" stopOpacity="0.1"/>
            </radialGradient>
            <radialGradient id="gradient3" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="oklch(60% 0.126 221.723)" stopOpacity="0.6"/>
              <stop offset="100%" stopColor="oklch(60% 0.126 221.723)" stopOpacity="0.1"/>
            </radialGradient>
          </defs>
        </svg>
      ...
      <div className="relative z-10 container mx-auto px-4 pb-16 mb-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg mb-8 text-base-content/60 max-w-lg">
